...
function drawRectangle(
  ...
  ctx.fillStyle = brickvisibility ? "#0095dd" : "transparent";
  ctx.fill();
}
...
function movePaddle() {
  ...
  if (paddle.x + paddle.w > canvas.width) {
    paddle.x = canvas.width - (paddle.w + 0.5);
  }
...
function initialiaze() {
  ...
  drawBall();
  drawRectangle(ctx, paddle.x, paddle.y, paddle.w, paddle.h, paddle.r);
  drawScore();
  drawBricks();
}
